use crate::workspace::code::CodeIndexSymbolProvider;
...
fn change_report(
	...
	catalog_generation: crate::workspace::snapshot::ResourceGeneration,
	index_generation: crate::workspace::snapshot::ResourceGeneration,
