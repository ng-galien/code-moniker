...
const SHAPE_TABLE: &[(&[u8], Shape, bool)] = &[
	...
	(b"column", Shape::Value, false),
	(b"constraint", Shape::Value, false),
	(b"index", Shape::Value, false),
	(b"index_key", Shape::Value, false),
	(b"index_include", Shape::Value, false),
	(b"index_predicate", Shape::Value, false),
	(b"constraint_column", Shape::Value, false),
	(b"trigger", Shape::Value, false),
