...
pub use crate::core::kinds::{
	...
	KIND_TRIGGER as TRIGGER, REF_ANNOTATES as ANNOTATES, REF_CALLS as CALLS,
	REF_DI_REGISTER as DI_REGISTER, REF_EXTENDS as EXTENDS, REF_IMPLEMENTS as IMPLEMENTS,
	REF_IMPORTS_MODULE as IMPORTS_MODULE, REF_IMPORTS_SYMBOL as IMPORTS_SYMBOL,
	REF_INSTANTIATES as INSTANTIATES, REF_METHOD_CALL as METHOD_CALL, REF_READS as READS,
	REF_REEXPORTS as REEXPORTS, REF_REFERENCES as REFERENCES, REF_RETURNS_TYPE as RETURNS_TYPE,
	REF_TYPED_AS as TYPED_AS, REF_USES_TYPE as USES_TYPE, REF_WRITES as WRITES,
};
...
pub const COLUMN: &[u8] = b"column";
pub const CONSTRAINT: &[u8] = b"constraint";
