...
pub fn extract_with_document(
	...
	let mut graph = match lang {
		...
		Lang::Markdown => extract_parsed::<code_moniker_core::lang::markdown::Lang>(
			uri,
			source,
			&anchor,
			deep,
		...
		Lang::Json => extract_parsed::<code_moniker_core::lang::json::Lang>(
			uri,
			source,
			&anchor,
			deep,
		...
		Lang::Yaml => extract_parsed::<code_moniker_core::lang::yaml::Lang>(
			uri,
			source,
			&anchor,
			deep,
