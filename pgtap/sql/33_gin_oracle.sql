...
INSERT INTO oracle_arr VALUES
	(1, ARRAY[
		'code+moniker://app/lang:ts/dir:src/module:util/class:Helper'::moniker,
		'code+moniker://app/lang:ts/dir:src/module:util/class:Helper/method:run(int)'::moniker
	]),
	(2, ARRAY[
		'code+moniker://app/lang:ts/dir:src/module:app/function:main()'::moniker,
		'code+moniker://app/lang:ts/dir:src/module:util/class:Helper'::moniker
	]),
	(3, ARRAY[
		'code+moniker://app/lang:java/package:com/package:acme/class:User'::moniker
	]),
	(4, ARRAY[]::moniker[]),
	(5, ARRAY[
		'code+moniker://other/lang:ts/dir:src/module:util/class:Helper'::moniker
	]);

INSERT INTO oracle_arr
	SELECT g + 100,
	       ARRAY[('code+moniker://pad/lang:ts/dir:src/module:m' || g::text)::moniker]
...
SELECT is(
	oracle_idx_id($q$ SELECT id FROM oracle_arr
	  WHERE ms @> ARRAY['code+moniker://app/lang:ts/dir:src/module:util/class:Helper'::moniker] $q$),
...
SELECT is(
	oracle_idx_id($q$ SELECT id FROM oracle_arr
	  WHERE ms @> ARRAY['code+moniker://app/path:never_there'::moniker] $q$),
	oracle_seq_id($q$ SELECT id FROM oracle_arr
	  WHERE ms @> ARRAY['code+moniker://app/path:never_there'::moniker] $q$),
...
SELECT is(
	oracle_idx_id($q$ SELECT id FROM oracle_arr
	  WHERE ms @> ARRAY['code+moniker://other/lang:ts/dir:src/module:util/class:Helper'::moniker] $q$),
	oracle_seq_id($q$ SELECT id FROM oracle_arr
	  WHERE ms @> ARRAY['code+moniker://other/lang:ts/dir:src/module:util/class:Helper'::moniker] $q$),
...
SELECT is(
	oracle_idx_id($q$ SELECT id FROM oracle_arr
	  WHERE ms && ARRAY['code+moniker://nope/x:y'::moniker] $q$),
	oracle_seq_id($q$ SELECT id FROM oracle_arr
	  WHERE ms && ARRAY['code+moniker://nope/x:y'::moniker] $q$),
	'&& : no overlap');
...
SELECT is(
	oracle_idx_id($q$ SELECT id FROM oracle_arr
	  WHERE ms @> ARRAY['code+moniker://app/lang:ts/dir:src/module:util/class:Helper'::moniker]
	    AND id < 10 $q$),
	oracle_seq_id($q$ SELECT id FROM oracle_arr
	  WHERE ms @> ARRAY['code+moniker://app/lang:ts/dir:src/module:util/class:Helper'::moniker]
	    AND id < 10 $q$),
...
SELECT is(
	oracle_idx_id($q$ SELECT id FROM oracle_arr
	  WHERE ms @> ARRAY['code+moniker://app/lang:ts/dir:src/module:util/class:Helper'::moniker]
	     OR ms @> ARRAY['code+moniker://app/lang:java/package:com/package:acme/class:User'::moniker] $q$),
	oracle_seq_id($q$ SELECT id FROM oracle_arr
	  WHERE ms @> ARRAY['code+moniker://app/lang:ts/dir:src/module:util/class:Helper'::moniker]
	     OR ms @> ARRAY['code+moniker://app/lang:java/package:com/package:acme/class:User'::moniker] $q$),
	'@> OR @> : two-key union');
...
SELECT is(
	oracle_idx_id($q$ SELECT id FROM oracle_arr
	  WHERE ms = ARRAY['code+moniker://app/lang:java/package:com/package:acme/class:User'::moniker] $q$),
	oracle_seq_id($q$ SELECT id FROM oracle_arr
	  WHERE ms = ARRAY['code+moniker://app/lang:java/package:com/package:acme/class:User'::moniker] $q$),
	'= : full-array equality');
...
SELECT is(
	oracle_idx_id($q$ SELECT 0 AS id FROM oracle_module
	  WHERE graph_def_monikers(graph) @> ARRAY[
	    'code+moniker://app/lang:ts/dir:src/module:lib/class:Lib'::moniker
