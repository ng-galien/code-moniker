...
use crate::cli::args::{Args, OutputFormat, OutputMode};
use crate::cli::extract;
use crate::cli::format;
use crate::cli::predicate::{self, MatchSet, Predicate, RefMatch};
use crate::cli::walk;
...
fn run_filter<W: Write>(
	...
	if !unknown.is_empty() {
		return Err(crate::cli::unknown_kinds_error(&unknown, &langs));
	}
